...
export namespace google.api {
    ...
    export class PythonSettings extends pb_1.Message {
        ...
        get experimental_features() {
            return pb_1.Message.getWrapperField(this, PythonSettings.ExperimentalFeatures, 2) as PythonSettings.ExperimentalFeatures;
        }
        set experimental_features(value: PythonSettings.ExperimentalFeatures) {
        ...
        static fromObject(data: {
            common?: ReturnType<typeof CommonLanguageSettings.prototype.toObject>;
            experimental_features?: ReturnType<typeof PythonSettings.ExperimentalFeatures.prototype.toObject>;
        }): PythonSettings {
            ...
            if (data.experimental_features != null) {
                message.experimental_features = PythonSettings.ExperimentalFeatures.fromObject(data.experimental_features);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.experimental_features, () => message.experimental_features = PythonSettings.ExperimentalFeatures.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export namespace PythonSettings {
        export class ExperimentalFeatures extends pb_1.Message {
            #one_of_decls: number[][] = [];
            constructor(data?: any[] | {
            ...
            static fromObject(data: {
                ...
                const message = new ExperimentalFeatures({});
            ...
            static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ExperimentalFeatures {
                const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ExperimentalFeatures();
                while (reader.nextField()) {
                    if (reader.isEndGroup())
                        break;
                    switch (reader.getFieldNumber()) {
            ...
            static deserializeBinary(bytes: Uint8Array): ExperimentalFeatures {
                return ExperimentalFeatures.deserialize(bytes);
            }
        }
    }
